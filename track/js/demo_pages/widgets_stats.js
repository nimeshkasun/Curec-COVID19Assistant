...
// ------------------------------
    ...
    function progressPercentage(element, radius, border, backgroundColor, foregroundColor, start, end) {
    ...
    function roundedProgressSingle(element, size, goal, color, typ) {
        if (typeof d3 == 'undefined') {
            console.warn('Warning - d3.min.js is not loaded.');
            return;
        }
        ...
        if(element) {
            ...
            var dataset = function () {
                if(typ==1){
                    var temp = localStorage.getItem("pl");
                    return [
                        {percentage: temp}
                    ];
                } else if(typ==2){
                    var temp = localStorage.getItem("mt");
                    return [
                        {percentage: temp}
                    ];
                } else if(typ==3){
                    var temp = localStorage.getItem("pa");
                    return [
                        {percentage: temp}
                    ];
                }  
    ...
    return {
        init: function() {
           ...
           _progressIcon('#progress_icon_three', 42, 2.5, "#00897B", "#fff", 0.73, "icon-bag");
            ...
            //_progressPercentage('#progress_percentage_three1', 46, 3, "#039BE5", "#fff", 0.90);
            //_progressPercentage('#progress_percentage_three2', 46, 3, "#00695C", "#fff", 0.27);
            //_progressPercentage('#progress_percentage_three3', 46, 3, "#2E7D32", "#fff", 0.55);
