							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
									<div class="slider-text-inner">
										<h1>Covid 19 <strong>Contact Places and Numbers</strong></h1>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="department-wrap animate-box">
							...
							<div class="grid-2 col-md-6">
								<div class="desc">
									<h2><a href="departments-single.php">Hospitals for COVID-19 Treatment</a></h2>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and
										Consonantia,</p>
									<div class="department-info">
										<div class="block">
											<h2><a href="doctors-single.php">Place 01</a></h2>
											<span>0000000000</span>
										</div>
										<div class="block">
											<h2><a href="departments-single.php">Place 02</a></h2>
											<span>0000000000</span>
										</div>
										<div class="block">
											<h2><a href="doctors.php">Place 03</a></h2>
											<span>0000000000</span>
										</div>
										<div class="block">
											<h2><a href="appointment.php">Place 04</a></h2>
											<span>000000000</span>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="department-wrap animate-box">
							...
							<div class="grid-2 col-md-6">
								<div class="desc">
									<h2><a href="departments-single.php">PCR testing laboratories for COVID-19</a></h2>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and
										Consonantia,</p>
									<div class="department-info">
										<div class="block">
					...
					<div class="col-md-4">
						<div class="department-wrap animate-box">
							...
							<div class="grid-2 col-md-6">
								<div class="desc">
									<h2><a href="departments-single.php">Dept catagory 03</a></h2>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and
										Consonantia,</p>
									<div class="department-info">
										<div class="block">
