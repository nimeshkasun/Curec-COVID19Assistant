        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li class="active">Covid 19 Patients</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td>Kalhara Perera</td>
                      <td>kasunadore@icloud.com</td>
                      <td>0779219315</td>
                      <td>2,846,000</td>
                    </tr>
                    <tr>
                      <td>Dinithi Pandithage</td>
                      <td>dinithi@gmail.com</td>
                      <td>071123456</td>
                      <td>2,746,000</td>
                    </tr>
                    <tr>
                      <td>Bhanuka Madurawala</td>
                      <td>Bhanuka@gmail.com</td>
                      <td>077123456</td>
                      <td>2,646,000</td>
                    </tr>
                    <tr>
                      <td>Maleesha Pieris</td>
