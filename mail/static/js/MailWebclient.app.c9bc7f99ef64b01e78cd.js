...
CMessageModel.prototype.fillFromOrToText = function ()
{
	...
	{
		var
			sToDisplay = this.oTo.getDisplay(TextUtils.i18n('MAILWEBCLIENT/LABEL_ME_RECIPIENT'), oAccount.email()),
			sCcDisplay = this.oCc.getDisplay(TextUtils.i18n('MAILWEBCLIENT/LABEL_ME_RECIPIENT'), oAccount.email()),
			sBccDisplay = this.oBcc.getDisplay(TextUtils.i18n('MAILWEBCLIENT/LABEL_ME_RECIPIENT'), oAccount.email()),
			aDisplay = []
		;
